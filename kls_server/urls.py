...
urlpatterns = [
    ...
    path('get_next_question/', views.GetNextQuestion.as_view(), name='get_next_question'),
    path('get_next_question_app/', views.GetNextQuestionApp.as_view(), name='get_next_question_app'),
    path('register_wrong_question/', views.RegisterWrongQuestion.as_view(), name='register_wrong_question'),
    path('register_wrong_question_app/', views.RegisterWrongQuestionApp.as_view(), name='register_wrong_question_app'),
    path('register_correct_question/', views.RegisterCorrectQuestion.as_view(), name='register_correct_question'),
    path('register_correct_question_app/', views.RegisterCorrectQuestionApp.as_view(), name='register_correct_question_app'),
    path('webcam_stream/<int:camera_index>/', views.WebcamStream.as_view(), name='webcam_stream'),
    path('get_metareport_values/', views.GetMetareportValues.as_view(), name='get_metareport_values'),
